...
from amlguard.eval.baseline import run_baseline
from amlguard.eval.scoring import CheckpointScore, TaskScore, score_checkpoint
from amlguard.eval.tasks import InvestigationTask, Stratum, build_tasks
from amlguard.llm import LLMClient, get_llm
from amlguard.persist import RUN_ID, atomic_write_json
from amlguard.pipeline import InvestigationPipeline
from amlguard.retrieval import NarrativeIndex
from amlguard.scopes import CURVE_ORDER, ProtectionScope, get_scope
...
def _narrative_fingerprint(scope_slug: str, protected_root: Path) -> str:
    ...
    """
    from amlguard.retrieval import corpus_fingerprint as _narr_fingerprint
...
def run_evaluation(
    ...
    from amlguard.observability import sync_eval_dataset

    sync_eval_dataset(
        "amlguard-investigation-tasks",
    ...
    for name in scope_names:
        ...
        from amlguard.observability import record_dataset_run_score

        for t in result.tasks:
            record_dataset_run_score(
                "amlguard-investigation-tasks", scope.name, t.task_id,

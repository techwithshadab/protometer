...
class Domain:
    ...
    investigation_prompt: str = "protometer-investigation-system"
    rationale_prompt: str = "protometer-rationale-system"
    judge_prompt: str = "protometer-judge-system"
...
_AML = Domain(
    ...
    investigation_prompt="protometer-investigation-system",
    rationale_prompt="protometer-rationale-system",
    judge_prompt="protometer-judge-system",

...
# RATIONALE_SYSTEM moved to config/prompts/protometer-rationale-system.txt (loaded via observability.managed_prompt).
...
def generate_rationale(
    ...
    *model's* basis rather than inventing an independent one. That keeps the rationale tied to
    ...
    system = managed_prompt("protometer-rationale-system", project=domain_project("aml"))

...
from protometer.llm import LLMClient, extract_json
from protometer.protect import Protector
from protometer.reidentify import AUDITOR, Role, reidentify, strip_tags
from protometer.retrieval import NarrativeIndex, RetrievedChunk

# SYSTEM_PROMPT moved to config/prompts/protometer-investigation-system.txt (loaded via observability.managed_prompt).
...
class InvestigationPipeline:
    ...
    def investigate(
        ...
        from protometer.observability import domain_project, managed_prompt

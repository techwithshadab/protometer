...
# config/prompts/ relative to the repo root (this file is src/protometer/prompts.py).
PROMPT_DIR = Path(__file__).resolve().parents[2] / "config" / "prompts"


def _path(name: str) -> Path:
    # Names are our own registry keys (protometer-*-system); reject anything that could escape
